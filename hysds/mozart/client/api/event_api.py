...
class EventApi(object):
    ...
    def post_add_log_event(self, type, status, event, **kwargs):  # noqa: E501
        ...
        :return: HySDS20Event20Log20Response28JSON29
    ...
    def post_add_log_event_with_http_info(self, type, status, event, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(HySDS20Event20Log20Response28JSON29, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            response_type='HySDS20Event20Log20Response28JSON29',  # noqa: E501
